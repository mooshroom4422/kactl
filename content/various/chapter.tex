...
\section{Optimization tricks}
	...
	\subsection{Pragmas}
		\begin{itemize}
			...
			\item \lstinline{#pragma GCC target("avx2,popcnt,lzcnt,abm,bmi,bmi2,fma,tune=native")} dopychanie kolanem + 03 i unroll
		\end{itemize}
	\kactlimport{FastMod.h}
	\kactlimport{FastInput.h}
	\kactlimport{PQComp.h}
	\kactlimport{CustomHash.h}
	\kactlimport{RandomTree.h}
